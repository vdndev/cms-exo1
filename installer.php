...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_silkroad_d3e4b02bd8edbc5a2703_20221207125611_archive.zip';
        const ARCHIVE_SIZE       = '23374825';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd3e4b02-07125611';
        const SECONDARY_PACKAGE_HASH = '3d94f21-07125611';
        const VERSION            = '1.5.1';
